# Simulationist Roguelike Project

This is a sited version of the LibTCOD template with Github CI Actions setup, ready for my experiment in building a simulationist RL using LLM coding.

## LibTCOD Template Documentation (to be removed when project is more settled)
## How this works
